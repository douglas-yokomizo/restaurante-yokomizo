    ...
    return (
        <>
            <section className='flex items-center justify-evenly'>
                ...
                <article className='w-[30%] flex flex-col justify-between items-start gap-8'>
                    <h2 className='font-bold text-2xl tracking-widest border-b-2 border-blue-950'>Sobre nós</h2>
